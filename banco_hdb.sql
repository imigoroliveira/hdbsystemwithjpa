...
DROP DATABASE IF EXISTS `db_hdb`;
...
INSERT IGNORE INTO `prontuarios` (`Id`, `Num_Prontuario`, `DataAbertura_Prontuario`, `NomePaciente_Prontuario`) VALUES
	(1, 1, '01/11/2020', 'Igor'),
	(2, 2, '01/11/2020', 'Sara'),
	(3, 3, '01/11/2020', 'Hellen'),
	(7, 8, '23/10/2019', 'Jose Henrique');
...
-- Copiando dados para a tabela db_hdb.usuarios: ~1 rows (aproximadamente)
